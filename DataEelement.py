...
from DataLinageObject import DataLinageObject, DataLinageObjectType
...
class ElementAbstractionLevel(IntEnum):
    ...
    # data entities & attributes of a specific database and related data transformation rules.
...
class DataElement(DataLinageObject):
    ...
    Data elements can be specified on different levels of abstraction and details
    """
    ...
    # Business key. Business key, wich usually concatenate system, data base and object name
